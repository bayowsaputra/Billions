...
export const PACKAGE_CONTENT = [
  {
    ...
    features: [
      { id:1,label: "1 Page", status: true },
      { id:2,label: "Free Domain", status: true },
      { id:3,label: "Free SSL", status: true },
      { id:4,label: "Free Design Assets", status: false },
      // Request revisi berapa hari
      { id:5,label: "Support Account Manager", status: true },
      { id:6,label: "SEO Friendly", status: true },
      { id:7,label: "Estimation 5-7 Days", status: true },
    ],
    isRecommended: false,
  },
  {
    ...
    features: [
      { id:1, label: "3 Page", status: true },
      { id:2, label: "Free Domain", status: true },
      { id:3, label: "Free SSL", status: true },
      { id:4, label: "Free Design Assets", status: true },
      // Request revisi berapa hari
      { id:5, label: "Support Account Manager", status: true },
      { id:6, label: "SEO Friendly", status: true },
      { id:7, label: "Estimation 7-10 Days", status: true },
    ],
    isRecommended: true,
  },
  {
    ...
    features: [
      { id: 1, label: "7 Page", status: true },
      { id: 2, label: "Free Domain", status: true },
      { id: 3, label: "Free SSL", status: true },
      { id: 4, label: "Free Hosting Server", status: true },
      { id: 5, label: "Free Design Assets", status: true },
      // Request revisi berapa hari
      { id: 6, label: "Support Account Manager", status: true },
      { id: 7, label: "SEO Friendly", status: true },
      { id: 8, label: "Estimation 14-20 Days", status: true },
    ],
    isRecommended: false,
  },
  {
    ...
    features: [
      { id:1, label: "More than 7 Page", status: true },
      { id:2, label: "Free Domain", status: true },
      { id:3, label: "Free SSL", status: true },
      { id:4, label: "Free Hosting Server", status: true },
      { id:5, label: "Free Design Assets + Customize", status: true },
      // Request revisi berapa hari
      { id:6, label: "Support Account Manager", status: true },
      { id:7, label: "SEO Friendly", status: true },
